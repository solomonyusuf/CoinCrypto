...
<body class="{{ $setting->theme }} bg-{{ $setting->theme }} text-text-primary overflow-x">
    @include('sweetalert::alert')
    
    <div data-overlay-container="true">
        <main class="flex min-h-screen flex-col">
            <header 
                class="top-0 z-[100] bg-{{ $setting->theme }}">
                <div class="bg-{{ $setting->theme }}">
            ...
            <footer class="bottom-0 flex w-full flex-col items-center  {{ $setting->theme == 'white' ? 'bg-[#FAFAFA]'  : 'bg-black' }} px-0 pb-[64px] pt-4 lg:pb-0">
                        ...
                        {{-- <div class="grid grid-cols-2 gap-8 lg:grid-cols-6">
                            <div class="column">
                                ...
                                <ul class="column-items mt-6 font-serif">
                                    <li
                                        ...
                                        <a aria-label="About Us" href="{{ route('about_us') }}">About Us</a>
                                    </li>
                                    <li
                                        class="font-metadata item-link cursor-pointer pb-2 leading-[1.5] tracking-[0.1px] text-[#676767] hover:underline">
                                        <a aria-label="Masthead" href="{{ route('masthead') }}">Masthead</a>
                                    </li>
                                    {{-- <li
                                        class="font-metadata item-link cursor-pointer pb-2 leading-[1.5] tracking-[0.1px] text-[#676767] hover:underline">
                            ...
                            <div class="column">
                                ...
                                <ul class="column-items mt-6 font-serif">
                                    <li
                                        class="font-metadata item-link cursor-pointer pb-2 leading-[1.5] tracking-[0.1px] text-[#676767] hover:underline">
                                        <a aria-label="Contact Us" href="{{ route('contact') }}">Contact Us</a>
                                    </li>
                                    <li
                                        class="font-metadata item-link cursor-pointer pb-2 leading-[1.5] tracking-[0.1px] text-[#676767] hover:underline">
                                        <a aria-label="Accessibility" href="{{ route('accessibility') }}">Accessibility</a>
                                    </li>
                                    <li
                                        class="font-metadata item-link cursor-pointer pb-2 leading-[1.5] tracking-[0.1px] text-[#676767] hover:underline">
                                        <a aria-label="Advertise" href="{{ route('advertise') }}">Advertise</a>
                                    </li>
                                    <li
                                        class="font-metadata item-link cursor-pointer pb-2 leading-[1.5] tracking-[0.1px] text-[#676767] hover:underline">
                            ...
                            <div class="col-span-4 flex flex-col gap-4">
                                ...
                                <div class="flex-start flex flex-wrap gap-x-4 gap-y-2 self-stretch"><span
                                        class="font-metadata item-link cursor-pointer break-keep pb-2 leading-[1.5] tracking-[0.1px] text-[#1A1A1A] hover:underline"><a
                                            aria-label="Ethics" href="{{ route('ethics') }}">Ethics</a></span><span
                                        class="font-metadata item-link cursor-pointer break-keep pb-2 leading-[1.5] tracking-[0.1px] text-[#1A1A1A] hover:underline"><a
                                            aria-label="Privacy" href="{{ route('privacy') }}">Privacy</a></span><span
                                        class="font-metadata item-link cursor-pointer break-keep pb-2 leading-[1.5] tracking-[0.1px] text-[#1A1A1A] hover:underline"><a
                                            aria-label="Terms of Use" href="{{ route('terms') }}">Terms of Use</a></span><span
                                        class="font-metadata item-link cursor-pointer pb-2 leading-[1.5] tracking-[0.1px] text-black hover:underline"><a
                                            href="{{ route('cookie') }}">Cookie Consent</a></span><span
                                        class="font-metadata item-link cursor-pointer break-keep pb-2 leading-[1.5] tracking-[0.1px] text-[#1A1A1A] hover:underline"><a
                                    ...
                                    <div class="flex w-full flex-col">
                                        <div  class="flex w-full flex-row items-center justify-between">
                                            ...
                                            <a class="lg:pl-4 xl:pl-6"
                                                target="_blank" href="{{ $setting->twitter }}">
                                            ...
                                            @endif
                                            @if($setting->facebook)
                                                <a  class="lg:pl-4 xl:pl-6" target="_blank" href="{{ $setting->facebook }}"><svg width="24"
                                            ...
                                            @endif
                                                {{-- <a aria-label="RSSFeed" data-position="RSSFeed"
                                                ...
                                                <a  class="lg:pl-4 xl:pl-6" target="_blank" href="{{ $setting->instagram }}"><svg width="22"
                                            ...
                                            @endif
                                            @if($setting->youtube)
                                            <a class="lg:pl-4 xl:pl-6" target="_blank" href="{{ $setting->youtube }}"><svg width="24"
                                            ...
                                            <a aria-label="Discord" data-position="Discord"
                                                class="lg:pl-4 xl:pl-6" target="_blank" href="{{ $setting->discord }}"><svg width="24"
                                                    height="24" fill="none" viewBox="0 0 24 24"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path
