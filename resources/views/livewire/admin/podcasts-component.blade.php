              ...
              <div class="col-2">
                ...
                <div class="modal fade" id="add" tabindex="-1"  aria-hidden="true"  wire:ignore.self>
                    <div class="modal-dialog modal-xl">
                        <form enctype="multipart/form-data" action="{{ route('create_podcast') }}" method="post" class="modal-content border-0">
                          @csrf  
                    ...
                    <td>
                        <div class="dropdown dropstart">
                            ...
                            <div class="modal fade" id="edit{{ $count }}" tabindex="-1"  aria-hidden="true" >
                                <div class="modal-dialog modal-xl">
                                    <form enctype="multipart/form-data" action="{{ route('update_podcast', $data->id) }}" method="post" class="modal-content border-0">
                                      @csrf  
                                      <div class="modal-header text-bg-primary">
