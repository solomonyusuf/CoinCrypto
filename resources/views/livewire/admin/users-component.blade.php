        ...
        <table class="table text-nowrap mb-0 align-middle">
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <span class="badge bg-primary-subtle text-primary d-inline-flex align-items-center gap-1"><i class="ti ti-check fs-4"></i>paid</span>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <span class="badge bg-danger-subtle text-danger d-inline-flex align-items-center gap-1"><i class="ti ti-x fs-4"></i>cancelled</span>
                    </td>
                    <td>
                        <div class="d-flex align-items-center">
                            <img src="../assets/images/profile/user-2.jpg" class="rounded-circle" width="40" height="40">
                ...
                <tr>
                    ...
                    <td>
                        <span class="badge bg-secondary-subtle text-secondary d-inline-flex align-items-center gap-1"><i class="ti ti-arrow-back-up fs-4"></i>refunded</span>
                    </td>
                    <td>
                        <div class="d-flex align-items-center">
