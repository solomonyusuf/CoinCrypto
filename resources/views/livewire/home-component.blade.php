<div>
  <section data-module-name="homepage" data-module-version="1.0.0" data-module-instance="default" class="flex-grow">
              ...
              <div class="min-w-full min-h-full">
                <div class="color-black relative flex items-start justify-center aw100% ah100%" style="height:100%">
                  ...
                  <div style="width:100%;height:100%"
                    ...
                    <svg xmlns:xlink="http://www.w3.org/1999/xlink" width="100" height="75" viewBox="0 0 100 75"
                      fill="none" xmlns="http://www.w3.org/2000/svg" class="opacity-30 [&amp;&gt;path]:fill-[#DCDCDD]">
                      <path
                ...
                <div class="
                  ...
                  <div class="bg-white flex gap-6 w-full shrink">
                    <div class="flex flex-col"><a class="text-color-charcoal-900 mb-4 hover:underline"
                      ...
                      <p class="flex gap-2 flex-col"></p><span class="mt-2 uppercase text-[#00733F] font-medium"><span
                          class="font-metadata mr-1 uppercase">Sponsored by</span><a
                          class="font-metadata mt-2 uppercase text-[#00733F] hover:underline" target="_blank"
                          href="https://www.platon.network/">PlatON</a></span>
                    </div><a title="PlatON: Paving the Way to Become the Visa of Web 3.0" class="flex shrink-0 flex-col"
                      href="/sponsored-content/platon-paving-the-way-to-become-the-visa-of-web-3-0"><img alt="CoinDesk"
                        loading="lazy" width="1280" height="960" decoding="async" data-nimg="1"
                ...
                <div class="bg-white flex gap-6 w-full shrink">
                  <div class="flex flex-col"><a class="text-color-charcoal-900 mb-4 hover:underline"
                    ...
                    <p class="font-body text-color-charcoal-600 mb-4 line-clamp-3">Christian
                      ...
                      million in BTC.</p>
                    <p class="flex gap-2 flex-col"><span class="font-metadata text-color-charcoal-600 uppercase">13
                        hours
                        ago</span></p>
                  </div><a
...
">
                  <div class="bg-white flex gap-6 w-full shrink">
                    <div class="flex flex-col"><a class="text-color-charcoal-900 mb-4 hover:underline"
                      ...
                      <p class="flex gap-2 flex-col"><span class="font-metadata text-color-charcoal-600 uppercase">Mar
                          20, 2025</span></p>
                    </div>
                  </div>
                </div>
...
">
                  <div class="bg-white flex gap-6 w-full shrink">
                    <div class="flex flex-col"><a class="text-color-charcoal-900 mb-4 hover:underline"
                      ...
                      <p class="flex gap-2 flex-col"><span class="font-metadata text-color-charcoal-600 uppercase">19
                          hours ago</span></p>
                    </div>
                  </div>
                </div>
                ...
                <div class="bg-white flex gap-6 w-full shrink">
                  <div class="flex flex-col"><a class="text-color-charcoal-900 mb-4 hover:underline"
                    ...
                    <p class="flex gap-2 flex-col"><span class="font-metadata text-color-charcoal-600 uppercase">13
                        hours
                        ago</span></p>
                  </div><a title="Gotbit Founder Aleksei Andriunin Pleads Guilty to Wire Fraud, Market Manipulation"
                    class="flex shrink-0 flex-col"
                    href="/policy/2025/03/20/gotbit-founder-aleksei-andriunin-pleads-guilty-to-wire-fraud-market-manipulation"><img
                      alt="Alexey Andryunin" loading="lazy" width="1000" height="1000" decoding="async" data-nimg="1"
                      class="lg:w-[9.5rem] lg:h-[9.5rem] sm:w-16 sm:h-16 xs:w-16 xs:h-16 rounded align-self-end object-cover"
...
">
                  <div class="bg-white flex gap-6 w-full shrink">
                    <div class="flex flex-col"><a class="text-color-charcoal-900 mb-4 hover:underline"
                      ...
                      <p class="flex gap-2 flex-col"><span class="font-metadata text-color-charcoal-600 uppercase">15
                          hours ago</span></p>
                    </div>
                  </div>
                </div>
...
">
                  <div class="bg-white flex gap-6 w-full shrink">
                    <div class="flex flex-col"><a class="text-color-charcoal-900 mb-4 hover:underline"
                      ...
                      <p class="flex gap-2 flex-col"><span class="font-metadata text-color-charcoal-600 uppercase">17
                          hours ago</span></p>
                    </div>
                  </div>
                </div>
          ...
          <div class="min-w-full min-h-full justify-center items-center">
            <div class="color-black relative flex items-start justify-center aw970px ah250px" style="height:250px">
              ...
              <div style="width:970px;height:250px"
                ...
                <svg xmlns:xlink="http://www.w3.org/1999/xlink" width="100" height="75" viewBox="0 0 100 75" fill="none"
                  xmlns="http://www.w3.org/2000/svg" class="opacity-30 [&amp;&gt;path]:fill-[#DCDCDD]">
                  <path
                    d="M37.1542 40.7009C39.0349 40.7009 40.5594 39.1733 40.5594 37.2889C40.5594 35.4045 39.0349 33.877 37.1542 33.877C35.2736 33.877 33.749 35.4045 33.749 37.2889C33.749 39.1733 35.2736 40.7009 37.1542 40.7009Z"
                    fill="#F8BF1E"></path>
                  <path
          ...
          <div class="flex flex-col gap-6">
            ...
            <div class="uppercase"><a target="" class="flex gap-2 items-center z-50 hover:z-50 " href="/newsletters">
                <h2 class="text-color-dark-grey font-title text-charcoal-600 hover:underline">
                  Newsletters</h2><svg class="" fill="none" height="24" viewBox="0 0 25 24" width="25"
                ...
                <div data-module-name="newsletter-sign-up-module" data-module-version="1.0.0"
                  ...
                  <div class="flex flex-col md:flex-row lg:flex-col xl:flex-row gap-4 justify-start items-center pt-2">
                    <div
                      ...
                      data-slot="base" data-filled="true" data-filled-within="true" data-has-value="true">
                        ...
                        <div data-slot="input-wrapper"
                          ...
                          <div data-slot="inner-wrapper" class="inline-flex w-full items-center h-full box-border">
                            <input data-slot="input"
                              ...
                              aria-describedby="react-aria-:R5rqhulnfbH3: react-aria-:R5rqhulnfbH4:" value="" />
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="flex gap-2 p-4 pl-6 items-center"><span
                          ...
                          up</span><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"
                          fill="none">
                          <mask id="mask0_2411_93" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0"
                            width="16" height="16">
                  ...
                  </div><span class="pt-4 font-metadata text-charcoal-600"><span class="text-color-dark-grey ">By
                      signing up, you will receive emails
                      about CoinDesk products and you agree to our </span><a
                      class="border-b-[1px] border-black !no-underline" href="/terms"><span
                        class="text-color-dark-grey ">terms of
                        use</span></a><span class="text-color-dark-grey "> and </span><a
                      class="border-b-[1px] border-black !no-underline" href="/privacy"><span
                        class="text-color-dark-grey ">privacy
                        policy</span></a><span
...
">
                  <div class="relative inline-block h-12 w-[60px]">
                    <img alt="elipse" loading="lazy" width="20" height="20" class="h-8 min-h-8 w-8 min-w-8"
                      style="color:transparent" src="/img/elipse.png" />
                    <span class="absolute bottom-0 right-0 font-body text-color-charcoal-900 uppercase">01
                      <!-- -->.
                    </span>
                  </div>
                  <div class="bg-white flex gap-6 w-full shrink flex-col md:flex-row">
                    <div class="flex flex-col"><a class="text-color-charcoal-900 mb-4 hover:underline"
                      ...
                      <p class="flex gap-2 flex-col"><span
                          ...
                          </span></span><span class="font-metadata text-color-charcoal-600 uppercase">Mar
                          18, 2025</span></p>
                    </div><a title="Bitcoin Pulls Back With Markets Nervous Ahead of Fed Meeting Results"
                      class="flex shrink-0 flex-col"
                      href="/markets/2025/03/18/bitcoin-pulls-back-with-markets-nervous-ahead-of-fed-meeting-results"><img
                        alt="" loading="lazy" width="416" height="234" decoding="async" data-nimg="1"
...
false
">
                  <div class="relative inline-block h-12 w-[60px]"><img alt="elipse" loading="lazy" width="20"
                      height="20" decoding="async" data-nimg="1" class="h-8 min-h-8 w-8 min-w-8"
                      style="color:transparent"
              ...
              <div class="grid grid-cols-1 lg:grid-cols-3 xl:grid-cols-1 gap-6">
                <div class="flex flex-col col-span-1 lg:col-span-2 xl:col-span-1">
                  ...
                  <div class="pb-6 uppercase"><a target="" class="flex gap-2 items-center z-50 hover:z-50 "
                      href="/opinion">
                      <h2 class="text-color-dark-grey font-title text-charcoal-600 hover:underline">
                        Opinion</h2><svg class="" fill="none" height="24" viewBox="0 0 25 24" width="25"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                          d="M5.5 13H16.67L11.79 17.88C11.4 18.27 11.4 18.91 11.79 19.3C12.18 19.69 12.81 19.69 13.2 19.3L19.79 12.71C20.18 12.32 20.18 11.69 19.79 11.3L13.21 4.69997C12.82 4.30997 12.19 4.30997 11.8 4.69997C11.41 5.08997 11.41 5.71997 11.8 6.10997L16.67 11H5.5C4.95 11 4.5 11.45 4.5 12C4.5 12.55 4.95 13 5.5 13Z"
                          fill="#676767"></path>
                          ...
                          <div class="flex flex-col-reverse gap-2"><a
                            ...
                            <p class="flex gap-2 flex-col"><span
                                class="font-metadata-lg font-medium text-color-charcoal-900 uppercase "><span
                                  class="mr-2">By
                                  <!-- --> <a title="Ben Charoenwong" class="text-color-charcoal-900 hover:underline"
                        ...
                        <div class="bg-white flex gap-6 w-full shrink justify-between">
                          <div class="flex flex-col-reverse gap-2"><a
                            ...
                            <p class="flex gap-2 flex-col"><span
                                class="font-metadata-lg font-medium text-color-charcoal-900 uppercase "><span
                                  class="mr-2">By
                                  <!-- --> <a title="Meg Lister" class="text-color-charcoal-900 hover:underline"
                        ...
                        <div class="bg-white flex gap-6 w-full shrink justify-between">
                          <div class="flex flex-col-reverse gap-2"><a
                            ...
                            <p class="flex gap-2 flex-col"><span
                                class="font-metadata-lg font-medium text-color-charcoal-900 uppercase "><span
                                  class="mr-2">By
                                  <!-- --> <a title="Hadley Stern" class="text-color-charcoal-900 hover:underline"
...
">
                        <div class="bg-white flex gap-6 w-full shrink justify-between">
                          <div class="flex flex-col-reverse gap-2"><a
                            ...
                            <p class="flex gap-2 flex-col"><span
                                class="font-metadata-lg font-medium text-color-charcoal-900 uppercase "><span
                                  class="mr-2">By
                                  <!-- --> <a title="Joshua Tan" class="text-color-charcoal-900 hover:underline"
                                    href="/author/joshua-tan">Joshua
                                    Tan</a>, <a title="Jillian Grennan" class="text-color-charcoal-900 hover:underline"
                          ...
                          </div><a title="Joshua Tan" class="flex shrink-0 flex-col" href="/author/joshua-tan"><img
                              alt="Joshua Tan" loading="lazy" width="128" height="128" decoding="async" data-nimg="1"
                              class="w-16 h-16 object-cover rounded-full max-w-full max-h-full object-cover"
                ...
                <div class="flex flex-col col-span-1">
                  ...
                  <div class="pb-6 uppercase"><a target="" class="flex gap-2 items-center z-50 hover:z-50 "
                      href="/press-release">
                      <h2 class="text-color-dark-grey font-title text-charcoal-600 hover:underline">
                        Press Releases</h2><svg class="" fill="none" height="24" viewBox="0 0 25 24" width="25"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                          d="M5.5 13H16.67L11.79 17.88C11.4 18.27 11.4 18.91 11.79 19.3C12.18 19.69 12.81 19.69 13.2 19.3L19.79 12.71C20.18 12.32 20.18 11.69 19.79 11.3L13.21 4.69997C12.82 4.30997 12.19 4.30997 11.8 4.69997C11.41 5.08997 11.41 5.71997 11.8 6.10997L16.67 11H5.5C4.95 11 4.5 11.45 4.5 12C4.5 12.55 4.95 13 5.5 13Z"
                          fill="#676767"></path>
                              ...
                              <div class="flex flex-col"><a class="text-color-charcoal-900 mb-4 hover:underline"
                                ...
                                <p class="flex gap-2 flex-col"><span
                                    class="font-metadata-lg font-medium text-color-charcoal-900 uppercase "><span
                                      class="mr-2">Paid for by
                                      <!-- --> <span>Saga</span>
                                    </span></span><span class="font-metadata text-color-charcoal-600 uppercase">Feb
                                    27, 2025</span></p>
                              </div>
                            </div>
                          </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  <div
                    ...
                    <div class="flex flex-col shrink-0 items-center justify-center w-full">
                      <img alt="Consensus Toronto 2025" loading="lazy" width="585" height="329" decoding="async"
                        data-nimg="1"
                  ...
                  <div
                    ...
                    <div class="flex flex-col gap-2">
                      ...
                      class="z-0 group relative inline-flex items-center justify-center box-border appearance-none select-none whitespace-nowrap font-normal subpixel-antialiased overflow-hidden tap-highlight-transparent data-[pressed=true]:scale-[0.97] outline-none data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-2 data-[focus-visible=true]:outline-focus data-[focus-visible=true]:outline-offset-2 px-4 min-w-20 text-small gap-2 rounded-small [&amp;&gt;svg]:max-w-[theme(spacing.8)] transition-transform-colors-opacity motion-reduce:transition-none bg-default text-default-foreground data-[hover=true]:opacity-hover h-10 w-[140px] border border-[#FFD200]"><span
                        ...
                        More</span><svg class="" fill="none" height="24" viewBox="0 0 24 24" width="24"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                          d="M5.5 13H16.67L11.79 17.88C11.4 18.27 11.4 18.91 11.79 19.3C12.18 19.69 12.81 19.69 13.2 19.3L19.79 12.71C20.18 12.32 20.18 11.69 19.79 11.3L13.21 4.69997C12.82 4.30997 12.19 4.30997 11.8 4.69997C11.41 5.08997 11.41 5.71997 11.8 6.10997L16.67 11H5.5C4.95 11 4.5 11.45 4.5 12C4.5 12.55 4.95 13 5.5 13Z"
                          fill="#262626"></path>
      ...
      <div class="grid">
        ...
        <div class="order-2 lg:order-1">
          <div class="flex flex-col">
            ...
            <div class="py-6 uppercase"><a target="" class="flex gap-2 items-center z-50 hover:z-50 " href="/podcasts">
                <h2 class="text-color-dark-grey font-title text-charcoal-600 hover:underline">
                  Podcasts</h2><svg class="" fill="none" height="24" viewBox="0 0 25 24" width="25"
                  xmlns="http://www.w3.org/2000/svg">
                  <path
                    d="M5.5 13H16.67L11.79 17.88C11.4 18.27 11.4 18.91 11.79 19.3C12.18 19.69 12.81 19.69 13.2 19.3L19.79 12.71C20.18 12.32 20.18 11.69 19.79 11.3L13.21 4.69997C12.82 4.30997 12.19 4.30997 11.8 4.69997C11.41 5.08997 11.41 5.71997 11.8 6.10997L16.67 11H5.5C4.95 11 4.5 11.45 4.5 12C4.5 12.55 4.95 13 5.5 13Z"
                    fill="#676767"></path>
            ...
            <div class="grid gap-6 grid-cols-4 md:grid-cols-8 lg:grid-cols-12 xl:grid-cols-16">
                ...
                <div class="flex flex-col gap-6">
                  ...
                  <div class="flex justify-center gap-6">
                    <div
                      ...
                      <a href="https://link.chtbl.com/MarketsDaily?platform=castbox" target="_blank" rel="noreferrer"
                        ...
                        href="https://link.chtbl.com/MarketsDaily?platform=google_podcasts" target="_blank"
                        rel="noreferrer" class="hover:opacity-80 transition-opacity"><img alt="" loading="lazy"
                        ...
                        href="https://link.chtbl.com/MarketsDaily?platform=itunes" target="_blank" rel="noreferrer"
                        class="hover:opacity-80 transition-opacity"><img alt="" loading="lazy" width="24" height="24"
                          decoding="async" data-nimg="1" style="color:transparent"
                        ...
                        href="https://link.chtbl.com/MarketsDaily?platform=pocket_casts" target="_blank"
                        rel="noreferrer" class="hover:opacity-80 transition-opacity"><img alt="" loading="lazy"
                          width="24" height="24" decoding="async" data-nimg="1" style="color:transparent"
                        ...
                        href="https://rss.art19.com/markets-daily" target="_blank" rel="noreferrer"
                        class="hover:opacity-80 transition-opacity"><img alt="" loading="lazy" width="24" height="24"
                          decoding="async" data-nimg="1" style="color:transparent"
                        ...
                        href="https://link.chtbl.com/MarketsDaily?platform=radio_public" target="_blank"
                        rel="noreferrer" class="hover:opacity-80 transition-opacity"><img alt="" loading="lazy"
                          width="24" height="24" decoding="async" data-nimg="1" style="color:transparent"
                        ...
                        href="https://link.chtbl.com/MarketsDaily?platform=spotify" target="_blank" rel="noreferrer"
                        class="hover:opacity-80 transition-opacity"><img alt="" loading="lazy" width="24" height="24"
                          decoding="async" data-nimg="1" style="color:transparent"
                        ...
                        href="https://link.chtbl.com/MarketsDaily?platform=stitcher" target="_blank" rel="noreferrer"
                        class="hover:opacity-80 transition-opacity"><img alt="" loading="lazy" width="24" height="24"
                          decoding="async" data-nimg="1" style="color:transparent"
              ...
              <div class="hidden lg:flex lg:flex-col order-2 lg:order-1 col-span-4 lg:col-span-3 xl:col-span-4">
                <div class="flex flex-col gap-2 min-w-[300px] md:min-w-full"><a class="hover:underline"
                    href="/podcasts/markets-daily">
                    <h3 class="text-color-black font-headline-2xs font-normal">Markets Daily
                      Crypto Roundup</h3>
                  </a><span class="text-color-black font-body-sm line-clamp-2 text-[#676767]">Tune
                ...
                <div class="flex flex-col gap-2 min-w-[300px] md:min-w-full"><a class="hover:underline"
                    href="/podcasts/generation-c">
                    <h3 class="text-color-black font-headline-2xs font-normal">Gen C</h3>
                  </a><span class="text-color-black font-body-sm line-clamp-2 text-[#676767]">Generation
                ...
                <div class="flex flex-col gap-2 min-w-[300px] md:min-w-full"><a class="hover:underline"
                    href="/podcasts/coindesks-money-reimagined">
                    <h3 class="text-color-black font-headline-2xs font-normal">CoinDesk’s
                      Money Reimagined</h3>
                  </a><span class="text-color-black font-body-sm line-clamp-2 text-[#676767]">Join
              ...
              <div class="hidden lg:flex lg:flex-col order-3 col-span-4 lg:col-span-3 xl:col-span-4">
                <div class="flex flex-col gap-2 min-w-[300px] md:min-w-full"><a class="hover:underline"
                    href="/podcasts/unchained">
                    <h3 class="text-color-black font-headline-2xs font-normal">Unchained
                    </h3>
                  </a><span class="text-color-black font-body-sm line-clamp-2 text-[#676767]">Unchained,
                ...
                <div class="flex flex-col gap-2 min-w-[300px] md:min-w-full"><a class="hover:underline"
                    href="/podcasts/hard-problems-bram-cohen">
            ...
            <div>
              ...
              <div class="grid grid-col-1 lg:grid-cols-2 gap-0 md:gap-6">
                <div>
                  ...
                  <div class="flex flex-col">
                    <div class="flex py-6 uppercase"><a target="" class="flex gap-2 items-center z-50 hover:z-50 "
                        href="/markets">
                        <h2 class="text-color-dark-grey font-title text-charcoal-600 hover:underline">
                          Markets</h2><svg class="" fill="none" height="24" viewBox="0 0 25 24" width="25"
                          xmlns="http://www.w3.org/2000/svg">
                          <path
                            d="M5.5 13H16.67L11.79 17.88C11.4 18.27 11.4 18.91 11.79 19.3C12.18 19.69 12.81 19.69 13.2 19.3L19.79 12.71C20.18 12.32 20.18 11.69 19.79 11.3L13.21 4.69997C12.82 4.30997 12.19 4.30997 11.8 4.69997C11.41 5.08997 11.41 5.71997 11.8 6.10997L16.67 11H5.5C4.95 11 4.5 11.45 4.5 12C4.5 12.55 4.95 13 5.5 13Z"
                            fill="#676767"></path>
                              ...
                              <p class="flex gap-2 flex-col"><span
                                  class="font-metadata-lg font-medium text-color-charcoal-900 uppercase flex md:hidden"><span
                                    ...
                                    <!-- --> <a title="Omkar Godbole" class="text-color-charcoal-900 hover:underline"
                                      ...
                                      Godbole</a>
                                  </span></span><span class="font-metadata text-color-charcoal-600 uppercase">34
                                  minutes ago</span></p>
                            </div><a
                ...
                <div>
                  ...
                  <div class="flex flex-col">
                    <div class="flex py-6 uppercase"><a target="" class="flex gap-2 items-center z-50 hover:z-50 "
                        href="/business">
                        <h2 class="text-color-dark-grey font-title text-charcoal-600 hover:underline">
                          Finance</h2><svg class="" fill="none" height="24" viewBox="0 0 25 24" width="25"
                          xmlns="http://www.w3.org/2000/svg">
                          <path
                            d="M5.5 13H16.67L11.79 17.88C11.4 18.27 11.4 18.91 11.79 19.3C12.18 19.69 12.81 19.69 13.2 19.3L19.79 12.71C20.18 12.32 20.18 11.69 19.79 11.3L13.21 4.69997C12.82 4.30997 12.19 4.30997 11.8 4.69997C11.41 5.08997 11.41 5.71997 11.8 6.10997L16.67 11H5.5C4.95 11 4.5 11.45 4.5 12C4.5 12.55 4.95 13 5.5 13Z"
                            fill="#676767"></path>
                              ...
                              <p class="flex gap-2 flex-col"><span
                                  class="font-metadata-lg font-medium text-color-charcoal-900 uppercase flex md:hidden"><span
                                    ...
                                    <!-- --> <a title="Krisztian Sandor" class="text-color-charcoal-900 hover:underline"
                                      ...
                                      Sandor</a>
                                  </span></span><span class="font-metadata text-color-charcoal-600 uppercase">12
                                  hours ago</span></p>
                            </div><a title="Tether Ranks Among Top Buyers of U.S. Treasuries in 2024, Firm Says"
                              class="flex shrink-0 flex-col"
                              href="/business/2025/03/20/tether-ranks-among-top-foreign-buyers-of-u-s-treasuries-in-2024-firm-says"><img
                                alt="Treasury image via Shutterstock" loading="lazy" width="1920" height="1080"
              ...
              <div class="hidden xl:flex lg:hidden md:flex justify-center items-center mt-6">
                <div class="w-full">
                  <div class="color-black relative flex items-start justify-center aw970px ah250px"
                    style="height:250px">
                    <div id="homepage_mid_desktop_5" data-freestar-ad="true" style="width:970px;height:250px"
                      class="transition-box duration-250 align-center background-repeat relative flex items-start justify-center ease-in [&amp;&gt;iframe]:m-auto aw970px ah250px">
                    </div>
                    <div style="width:970px;height:250px"
                      class="min-w-full animate-shimmer will-change-background-position via-18% to-33% from-8% absolute mb-0 ml-auto mr-auto mt-0 flex items-center justify-center bg-gradient-to-r from-[#f6f7f8] via-[#edeef1] to-[#f6f7f8] bg-[length:200%_100%] opacity-100 aw970px ah250px">
                ...
                <div>
                  ...
                  <div class="flex flex-col">
                    <div class="flex py-6 uppercase"><a target="" class="flex gap-2 items-center z-50 hover:z-50 "
                        href="/tech">
                        <h2 class="text-color-dark-grey font-title text-charcoal-600 hover:underline">
                          Tech</h2><svg class="" fill="none" height="24" viewBox="0 0 25 24" width="25"
                          xmlns="http://www.w3.org/2000/svg">
                          <path
                            d="M5.5 13H16.67L11.79 17.88C11.4 18.27 11.4 18.91 11.79 19.3C12.18 19.69 12.81 19.69 13.2 19.3L19.79 12.71C20.18 12.32 20.18 11.69 19.79 11.3L13.21 4.69997C12.82 4.30997 12.19 4.30997 11.8 4.69997C11.41 5.08997 11.41 5.71997 11.8 6.10997L16.67 11H5.5C4.95 11 4.5 11.45 4.5 12C4.5 12.55 4.95 13 5.5 13Z"
                            fill="#676767"></path>
                          ...
                          <div class="bg-white flex gap-6 w-full shrink flex-col">
                            <div class="flex flex-col"><a class="text-color-charcoal-900 mb-4 hover:underline"
                              ...
                              <p class="flex gap-2 flex-col"><span
                                  class="font-metadata-lg font-medium text-color-charcoal-900 uppercase flex md:hidden"><span
                                    class="mr-2">By
                                    <!-- --> <a title="Jamie Crawley" class="text-color-charcoal-900 hover:underline"
                                      href="/author/jamie-crawley">Jamie
                                      Crawley</a>
                                  </span></span><span class="font-metadata text-color-charcoal-600 uppercase">14
                                  hours ago</span></p>
                            </div><a title="Bitcoin DeFi Expansion Faces Fork Dilemma as Developers Explore ZK Proofs"
                              class="flex shrink-0 flex-col"
                ...
                <div>
                  ...
                  <div class="flex flex-col">
                    <div class="flex py-6 uppercase"><a target="" class="flex gap-2 items-center z-50 hover:z-50 "
                        href="/policy">
                        <h2 class="text-color-dark-grey font-title text-charcoal-600 hover:underline">
                          Policy</h2><svg class="" fill="none" height="24" viewBox="0 0 25 24" width="25"
                          xmlns="http://www.w3.org/2000/svg">
                          <path
                            d="M5.5 13H16.67L11.79 17.88C11.4 18.27 11.4 18.91 11.79 19.3C12.18 19.69 12.81 19.69 13.2 19.3L19.79 12.71C20.18 12.32 20.18 11.69 19.79 11.3L13.21 4.69997C12.82 4.30997 12.19 4.30997 11.8 4.69997C11.41 5.08997 11.41 5.71997 11.8 6.10997L16.67 11H5.5C4.95 11 4.5 11.45 4.5 12C4.5 12.55 4.95 13 5.5 13Z"
                            fill="#676767"></path>
                          ...
                          <div class="bg-white flex gap-6 w-full shrink flex-col">
                            <div class="flex flex-col"><a class="text-color-charcoal-900 mb-4 hover:underline"
                              ...
                              <p class="flex gap-2 flex-col"><span
                                  class="font-metadata-lg font-medium text-color-charcoal-900 uppercase flex md:hidden"><span
                                    class="mr-2">By
                                    <!-- --> <a title="Jesse Hamilton" class="text-color-charcoal-900 hover:underline"
                                      href="/author/jesse-hamilton">Jesse
                                      Hamilton</a>
                                  </span></span><span class="font-metadata text-color-charcoal-600 uppercase">8
                                  hours ago</span></p>
                            </div><a
                              ...
                              href="/policy/2025/03/20/u-s-bank-agency-cuts-reputational-risk-from-exams-after-crypto-sector-cites-issues"><img
                                alt="CoinDesk placeholder image" loading="lazy" width="1056" height="594"
                                decoding="async" data-nimg="1"
                                class="w-full md:w-60 md:h-[135px] lg:w-[416px] lg:h-[234px] rounded align-self-end aspect-video object-cover object-cover"
                                style="color:transparent"
                                srcSet="/_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2Fs3y3vcno%2Fproduction%2Fac6bf763b67c66aeb40bc1b8d64de9e4fea8527f-2000x1500.png%3Fw%3D328%26auto%3Dformat&amp;w=1080&amp;q=75 1x, /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2Fs3y3vcno%2Fproduction%2Fac6bf763b67c66aeb40bc1b8d64de9e4fea8527f-2000x1500.png%3Fw%3D328%26auto%3Dformat&amp;w=3840&amp;q=75 2x"
                ...
                <div>
                  ...
                  <div class="flex flex-col">
                    <div class="flex py-6 uppercase"><a target="" class="flex gap-2 items-center z-50 hover:z-50 "
                        ...
                        <h2 class="text-color-dark-grey font-title text-charcoal-600 hover:underline">
                          Consensus Magazine</h2><svg class="" fill="none" height="24" viewBox="0 0 25 24" width="25"
                          xmlns="http://www.w3.org/2000/svg">
                          <path
                            d="M5.5 13H16.67L11.79 17.88C11.4 18.27 11.4 18.91 11.79 19.3C12.18 19.69 12.81 19.69 13.2 19.3L19.79 12.71C20.18 12.32 20.18 11.69 19.79 11.3L13.21 4.69997C12.82 4.30997 12.19 4.30997 11.8 4.69997C11.41 5.08997 11.41 5.71997 11.8 6.10997L16.67 11H5.5C4.95 11 4.5 11.45 4.5 12C4.5 12.55 4.95 13 5.5 13Z"
                            fill="#676767"></path>
                          ...
                          <div class="bg-white flex gap-6 w-full shrink flex-col">
                            <div class="flex flex-col"><a class="text-color-charcoal-900 mb-4 hover:underline"
                              ...
                              <p class="flex gap-2 flex-col"><span
                                  class="font-metadata-lg font-medium text-color-charcoal-900 uppercase flex md:hidden"><span
                                    class="mr-2">By
                                    <!-- --> <a title="Jack O’Holleran" class="text-color-charcoal-900 hover:underline"
                                      href="/author/jack-o-holleran">Jack
                                      O’Holleran</a>
                                  </span></span><span class="font-metadata text-color-charcoal-600 uppercase">Jul
                                  12, 2024</span></p>
                            </div><a title="Why Blockbuster Games Will Soon Be Built on Modular Appchains"
                              class="flex shrink-0 flex-col"
                              href="/consensus-magazine/2024/07/12/why-blockbuster-games-will-soon-be-built-on-modular-appchains"><img
                                alt="A scene from the trailer for Grand Theft Auto 6 (Rockstar Games)." loading="lazy"
                                width="1920" height="1080" decoding="async" data-nimg="1"
                                class="w-full md:w-60 md:h-[135px] lg:w-[416px] lg:h-[234px] rounded align-self-end aspect-video object-cover object-cover"
                ...
                <div>
                  ...
                  <div class="flex flex-col">
                    <div class="flex py-6 uppercase"><a target="" class="flex gap-2 items-center z-50 hover:z-50 "
                        href="/learn">
                        <h2 class="text-color-dark-grey font-title text-charcoal-600 hover:underline">
                          Learn</h2><svg class="" fill="none" height="24" viewBox="0 0 25 24" width="25"
                          xmlns="http://www.w3.org/2000/svg">
                          <path
                            d="M5.5 13H16.67L11.79 17.88C11.4 18.27 11.4 18.91 11.79 19.3C12.18 19.69 12.81 19.69 13.2 19.3L19.79 12.71C20.18 12.32 20.18 11.69 19.79 11.3L13.21 4.69997C12.82 4.30997 12.19 4.30997 11.8 4.69997C11.41 5.08997 11.41 5.71997 11.8 6.10997L16.67 11H5.5C4.95 11 4.5 11.45 4.5 12C4.5 12.55 4.95 13 5.5 13Z"
                            fill="#676767"></path>
                          ...
                          <div class="bg-white flex gap-6 w-full shrink flex-col">
                            <div class="flex flex-col"><a class="text-color-charcoal-900 mb-4 hover:underline"
                              ...
                              <p class="flex gap-2 flex-col"><span
                                  class="font-metadata-lg font-medium text-color-charcoal-900 uppercase flex md:hidden"><span
                                    class="mr-2">By
                                    <!-- --> <a title="Joe Lautzenhiser" class="text-color-charcoal-900 hover:underline"
                                      href="/author/joe-lautzenhiser">Joe
                                      Lautzenhiser</a>
                                  </span></span><span class="font-metadata text-color-charcoal-600 uppercase">May
                                  14, 2024</span></p>
                            </div><a title="How to Buy Solana" class="flex shrink-0 flex-col"
                              href="/learn/how-to-buy-solana"><img alt="(Danny Nelson/CoinDesk)" loading="lazy"
                                width="1920" height="1080" decoding="async" data-nimg="1"
                                class="w-full md:w-60 md:h-[135px] lg:w-[416px] lg:h-[234px] rounded align-self-end aspect-video object-cover object-cover"
