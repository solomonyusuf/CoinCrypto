        ...
        <div class="container-fluid">
              ...
              <div class="col-lg-6 ps-lg-0">
                <div class="p-7 p-lg-5 border flex-grow-1 rounded-end-3">
                  <div class="py-4 d-flex flex-column gap-3">
                    <div class="d-flex">
                      <p class="fs-2 px-2 rounded-pill bg-muted bg-opacity-25 text-dark mb-0">Web
                        Development
                      </p>
                    </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-4 col-md-6">
              <div class="card rounded-3 overflow-hidden">
                <a href="../main/frontend-blogdetailpage.html" class="position-relative">
                  <img src="../assets/images/blog/blog-img5.jpg" alt="blog image" class="w-100 img-fluid">
                  <div class="position-absolute bottom-0 end-0 me-9 mb-3">
                    <p class="text-dark fs-2 px-2 rounded-pill bg-white mb-0 ">2 min Read</p>
                  </div>
                  <div class="position-absolute bottom-0 ms-7 mb-n9">
            ...
            <div class="col-lg-4 col-md-6">
              <div class="card rounded-3 overflow-hidden">
                <a href="../main/frontend-blogdetailpage.html" class="position-relative">
                  <img src="../assets/images/blog/blog-img6.jpg" alt="blog image" class="w-100 img-fluid">
                  <div class="position-absolute bottom-0 end-0 me-9 mb-3">
                    <p class="text-dark fs-2 px-2 rounded-pill bg-white mb-0 ">2 min Read</p>
                  </div>
                  <div class="position-absolute bottom-0 ms-7 mb-n9">
            ...
            <div class="col-lg-4 col-md-6">
              <div class="card rounded-3 overflow-hidden">
                <a href="../main/frontend-blogdetailpage.html" class="position-relative">
                  <img src="../assets/images/blog/blog-img7.jpg" alt="blog image" class="w-100 img-fluid">
                  <div class="position-absolute bottom-0 end-0 me-9 mb-3">
                    <p class="text-dark fs-2 px-2 rounded-pill bg-white mb-0 ">2 min Read</p>
                  </div>
                  <div class="position-absolute bottom-0 ms-7 mb-n9">
            ...
            <div class="col-lg-4 col-md-6">
              <div class="card rounded-3 overflow-hidden">
                <a href="../main/frontend-blogdetailpage.html" class="position-relative">
                  <img src="../assets/images/blog/blog-img8.jpg" alt="blog image" class="w-100 img-fluid">
                  <div class="position-absolute bottom-0 end-0 me-9 mb-3">
                    <p class="text-dark fs-2 px-2 rounded-pill bg-white mb-0 ">2 min Read</p>
                  </div>
                  <div class="position-absolute bottom-0 ms-7 mb-n9">
            ...
            <div class="col-lg-4 col-md-6">
              <div class="card rounded-3 overflow-hidden">
                <a href="../main/frontend-blogdetailpage.html" class="position-relative">
                  <img src="../assets/images/blog/blog-img9.jpg" alt="blog image" class="w-100 img-fluid">
                  <div class="position-absolute bottom-0 end-0 me-9 mb-3">
                    <p class="text-dark fs-2 px-2 rounded-pill bg-white mb-0 ">2 min Read</p>
                  </div>
                  <div class="position-absolute bottom-0 ms-7 mb-n9">
