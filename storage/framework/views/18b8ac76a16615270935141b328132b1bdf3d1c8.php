                            ...
                            <div class="notes-content">
                              <div>
                                ...
                                <div class="mb-3">
                                  ...
                                  <div class="mb-3">
                                    <label  class="form-label">Facebook *</label>
                                    <input  name='facebook' value="<?php echo e(isset($data->socicals[0]) ? $data->socicals[0]->facebook : ''); ?>" placeholder="" type="text" class="form-control">
                                  </div>
                                  <div class="mb-3">
                                    <label  class="form-label">Instagram *</label>
                                    <input  name='instagram' value="<?php echo e(isset($data->socicals[0]) ? $data->socicals[0]->instagram : ''); ?>" placeholder="" type="text" class="form-control">
                                  </div>
                                  <div class="mb-3">
                                    <label  class="form-label">Twitter(X) *</label>
                                    <input  name='twitter' value="<?php echo e(isset($data->socicals[0]) ? $data->socicals[0]->twitter  : ''); ?>" placeholder="" type="text" class="form-control">
                                  </div>
                                  <div class="mb-3">
                                    <label  class="form-label">TikTok *</label>
                                    <input  name='tiktok' value="<?php echo e(isset($data->socicals[0]) ? $data->socicals[0]->tiktok : ''); ?>" placeholder="" type="text" class="form-control">
                                  </div>
                                  <div class="mb-3">
                                    <label  class="form-label">Youtube *</label>
                                    <input  name='youtube' value="<?php echo e(isset($data->socicals[0]) ? $data->socicals[0]->youtube : ''); ?>" placeholder="" type="text" class="form-control">
                                  </div>
                                  <div class="mb-3">
                                    <label  class="form-label">Telegram *</label>
                                    <input  name='telegram' value="<?php echo e(isset($data->socicals[0]) ? $data->socicals[0]->telegram : ''); ?>" placeholder="" type="text" class="form-control">
                                  </div>
                                  <div class="mb-3">
                                    <label  class="form-label">Newsletter *</label>
                                    <select required name='newsletter_id' class="form-control">
