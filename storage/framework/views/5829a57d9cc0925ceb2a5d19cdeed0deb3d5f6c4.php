              ...
              <div class="card border-0 zoom-in bg-primary-subtle shadow-none">
                <div class="card-body">
                  <div class="text-center">
                    ...
                    <h5 class="fw-semibold text-primary mb-0"><?php echo e(number_format($users)); ?></h5>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="card border-0 zoom-in bg-warning-subtle shadow-none">
                  <div class="card-body">
                    <div class="text-center">
                      ...
                      <h5 class="fw-semibold text-warning mb-0"><?php echo e(number_format($articles)); ?></h5>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card border-0 zoom-in bg-info-subtle shadow-none">
                <div class="card-body">
                  <div class="text-center">
                    ...
                    <h5 class="fw-semibold text-info mb-0"><?php echo e(number_format($newsletters)); ?></h5>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="card border-0 zoom-in bg-danger-subtle shadow-none">
                <div class="card-body">
                  <div class="text-center">
                    ...
                    <h5 class="fw-semibold text-danger mb-0"><?php echo e(number_format($events)); ?></h5>
                  </div>
                </div>
              </div>
            </div> 
              ...
              <div class="card border-0 zoom-in bg-info-subtle shadow-none">
                <div class="card-body">
                  <div class="text-center">
                    ...
                    <h5 class="fw-semibold text-info mb-0"><?php echo e(number_format($videos)); ?></h5>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="card border-0 zoom-in bg-danger-subtle shadow-none">
                <div class="card-body">
                  <div class="text-center">
                    ...
                    <h5 class="fw-semibold text-danger mb-0"><?php echo e(number_format($podcasts)); ?></h5>
                  </div>
                </div>
              </div>
            </div> 
