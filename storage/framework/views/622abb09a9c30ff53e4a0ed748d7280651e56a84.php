          ...
          <div class="social-icons flex h-full w-full items-center">
            <div class="flex w-full flex-col">
                <div  class="flex w-full flex-row items-center justify-between">
                    ...
                    <?php endif; ?>
                    <?php if($socical?->facebook): ?>
                        <a  class="lg:pl-4 xl:pl-6" target="_blank" href="<?php echo e($socical->facebook); ?>"><svg width="24"
                    ...
                    <?php endif; ?>
                        ...
                        <?php if($socical?->instagram): ?>
                        <a  class="lg:pl-4 xl:pl-6" target="_blank" href="<?php echo e($socical->instagram); ?>"><svg width="22"
                    ...
                    <?php endif; ?>
                    <?php if($socical?->youtube): ?>
                    <a class="lg:pl-4 xl:pl-6" target="_blank" href="<?php echo e($socical->youtube); ?>"><svg width="24"
