              ...
              <div class="col-2">
                ...
                <div class="modal fade" id="add" tabindex="-1"  aria-hidden="true">
                    <div class="modal-dialog modal-xl">
                        <form enctype="multipart/form-data" action="<?php echo e(route('create_video')); ?>" method="post" class="modal-content border-0">
                          <?php echo csrf_field(); ?>  
        ...
        <table id="table"  class="table text-nowrap mb-0 align-middle">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <h6>
                           <?php echo e($data?->video_category?->title); ?>
                    ...
                    <td>
                        <div class="dropdown dropstart">
                            ...
                            <div class="modal fade" id="edit<?php echo e($count); ?>" tabindex="-1"  aria-hidden="true" >
                                <div class="modal-dialog modal-xl">
                                    <form enctype="multipart/form-data" action="<?php echo e(route('update_video', $data->id)); ?>" method="post" class="modal-content border-0">
                                      <?php echo csrf_field(); ?>  
                                      <div class="modal-header text-bg-primary">
                                                  ...
                                                  <div class="mb-3">
                                                    ...
                                                    <div class="mb-3">
                                                     ...
                                                     <div class="mb-3"  wire:ignore>
                                                      <label  class="form-label">Content *</label>
                                                      <textarea id="text<?php echo e($count); ?>"  required name="description" style="height:400px;"  placeholder="" type="text" class="form-control"><?php echo $data->description; ?></textarea>
                                                    </div>
...
<?php /**PATH C:\xampp\htdocs\CoinCrypto\resources\views/livewire/admin/videos-component.blade.php ENDPATH**/ ?>