          ...
          <div><!-- ---------------------------------- -->
            ...
            <nav class="sidebar-nav scroll-sidebar simplebar-scrollable-y" data-simplebar="init"><div class="simplebar-wrapper" style="margin: 0px -24px;"><div class="simplebar-height-auto-observer-wrapper"><div class="simplebar-height-auto-observer"></div></div><div class="simplebar-mask"><div class="simplebar-offset" style="right: 0px; bottom: 0px;"><div class="simplebar-content-wrapper" tabindex="0" role="region" aria-label="scrollable content" style="height: 100%; overflow: hidden scroll;"><div class="simplebar-content" style="padding: 0px 24px;">
              <ul id="sidebarnav">
                ...
                <li class="sidebar-item">
                  <a class="sidebar-link  <?php echo e(Route::is('dashboard') ? 'active' : ''); ?>" href="<?php echo e(route('dashboard')); ?>" id="get-url" aria-expanded="false">
                    <span>
                ...
                <li class="sidebar-item">
                  <a class="sidebar-link  <?php echo e(Route::is('admin_users') ? 'active' : ''); ?>" href="<?php echo e(route('admin_users')); ?>" aria-expanded="false">
                    <span>
                ...
                <li class="sidebar-item">
                  <a class="sidebar-link  <?php echo e(Route::is('article_tags') ? 'active' : ''); ?>" href="<?php echo e(route('article_tags')); ?>" aria-expanded="false">
                    <span>
                      <i class="ti ti-tag"></i>
                    </span>
                ...
                <li class="sidebar-item">
                  <a class="sidebar-link  <?php echo e(Route::is('admin_articles') ? 'active' : ''); ?>" href="<?php echo e(route('admin_articles')); ?>" aria-expanded="false">
                    <span>
                ...
                <li class="sidebar-item">
                  <a class="sidebar-link  <?php echo e(Route::is('admin_event') ? 'active' : ''); ?>" href="<?php echo e(route('admin_event')); ?>" aria-expanded="false">
                    <span class="d-flex">
               ...
               <li class="sidebar-item">
                  <a class="sidebar-link  <?php echo e(Route::is('admin_video_tags') ? 'active' : ''); ?>" href="<?php echo e(route('admin_video_tags')); ?>" aria-expanded="false">
                    <span class="d-flex">
                      <i class="ti ti-tag"></i>
                    </span>
                ...
                <li class="sidebar-item">
                  <a class="sidebar-link  <?php echo e(Route::is('admin_videos') ? 'active' : ''); ?>" href="<?php echo e(route('admin_videos')); ?>" aria-expanded="false">
                    <span class="d-flex">
                 ...
                 <li class="sidebar-item">
                  <a class="sidebar-link  <?php echo e(Route::is('admin_podcasts') ? 'active' : ''); ?>" href="<?php echo e(route('admin_podcasts')); ?>" aria-expanded="false">
                    <span class="d-flex">
            ...
            <div class="fixed-profile p-3 mx-4 mb-2 bg-secondary-subtle rounded mt-3">
              <div class="hstack gap-3">
                <?php if($user?->image): ?>
                <div class="john-img">
                  <img src="<?php echo e(asset($user?->image)); ?>" class="rounded-circle" width="40" height="40" alt="modernize-img">
                </div>
                <?php endif; ?>
                <div class="john-title">
                  <h6 class="mb-0 fs-4 fw-semibold"><?php echo e($user?->first_name); ?></h6>
                  <span class="fs-2"><?php echo e($user?->role?->title); ?></span>
                </div>
                <a href="<?php echo e(route('logout')); ?>" class="border-0 bg-transparent text-primary ms-auto" tabindex="0" type="button" aria-label="logout" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="logout">
