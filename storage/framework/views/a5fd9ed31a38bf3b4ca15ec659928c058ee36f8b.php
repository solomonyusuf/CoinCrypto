  ...
  <section class="flex-grow">
    <div class="container mx-auto xs:p-4 xs:grid-cols-4 xs:gap-4 sm:p-4 sm:grid-cols-4 sm:gap-4 md:p-6 md:grid-cols-8 md:gap-6 lg:p-6 lg:grid-cols-12 lg:gap-6 xl:p-6 xl:grid-cols-16 xl:gap-6">
      ...
      <div class="grid gap-4 md:gap-6 grid-cols-4 md:grid-cols-8 lg:grid-cols-12">
        ...
        <?php if($setting->top_left_article_show): ?>
        <?php if($latest): ?>
        ...
        <?php endif; ?>
        <?php endif; ?>
        <?php if($setting->top_right_article_show): ?>
        <?php if($video): ?>
...
?>
        ...
        <?php if($setting->second_right_show): ?>
...
} elseif ($_instance->childHasBeenRendered('l3017988399-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l3017988399-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3017988399-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3017988399-1');
} else {
    $response = \Livewire\Livewire::mount('widget.wide-advert-component', ['type'=> 'home']);
    $html = $response->html();
    $_instance->logRenderedChild('l3017988399-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
      </div>
      ...
      <div class="grid">
        ...
        <div class="order-3">
          <div class="grid gap-4 grid-cols-4 md:gap-6 md:grid-cols-8 lg:grid-cols-12 xl:grid-cols-16">
            ...
            <?php if($setting->third_section_show): ?>
              ...
              <div class="grid order-4 xl:order-1 md:order-3 col-span-4 md:col-span-8 lg:col-span-12 xl:col-span-4 xl:row-span-8 gap-6">
                <div class="grid grid-cols-1 lg:grid-cols-3 xl:grid-cols-1 gap-6">
                  ...
                  ?>
                  <?php if($setting->fourth_section_show): ?>
                  ...
                  ?>
                  <?php if($setting->fifth_section_show): ?>
