    ...
    <section
        ...
        <div  class="container mx-auto xs:p-4 xs:grid-cols-4 xs:gap-4 sm:p-4 sm:grid-cols-4 sm:gap-4 md:p-6 md:grid-cols-8 md:gap-6 lg:p-6 lg:grid-cols-12 lg:gap-6 xl:p-6 xl:grid-cols-16 xl:gap-6">
            <div class="flex flex-wrap flex-col justify-center mdmax:ml-0 mdmax:mr-0 mb-8 container-tablet-medium container-desktop-lg container-desktop-xl">
                <h1 class="font-title <?php echo e($setting->theme == 'white' ? 'text-color-dark-grey text-charcoal-900' : 'text-color-white'); ?> mb-12 uppercase"><?php echo e($category->title); ?></h1>
                <div class="grid xl:grid-cols-3 sm:grid-cols-4 xs:grid-cols-2 gap-4 grid-flow-row-dense">
                    <div class="row-span-2 col-span-2 xl:col-span-2 lg:col-span-4 sm:col-span-4 xs:col-span-2">
                        <div class=" flex flex-col gap-1 md:flex-row false  ">
                            <div class="<?php echo e($setting->theme == 'white' ? 'bg-white': 'bg-black'); ?> flex gap-6 w-full shrink mdmax:flex-col justify-between">
                                ...
                                <div class="flex flex-col">
                                    <a class="<?php echo e($setting->theme == 'white' ? 'text-color-dark-grey text-charcoal-900' : 'text-color-white'); ?>mb-4 hover:underline"
                                        ...
                                        <h2 class="font-headline font-medium <?php echo e($setting->theme == 'white' ? 'text-color-dark-grey text-charcoal-900' : 'text-color-white'); ?>">
                                            <?php echo e($first->title); ?>

                                        </h2>
                                    </a>
                                    <p class="font-body <?php echo e($setting->theme == 'white' ? 'text-color-dark-grey text-charcoal-600' : 'text-color-white'); ?> mdmax:hidden mb-4 line-clamp-3">
                                    ...
                                    <p class="flex gap-2 flex-col">
                                        <span class="font-metadata-lg font-medium <?php echo e($setting->theme == 'white' ? 'text-color-dark-grey text-charcoal-900' : 'text-color-white'); ?> uppercase ">
                                            <span lass="mr-2">By 
                                                ...
                                                ,
                                                <?php endif; ?>
                                                <a title="" class="<?php echo e($setting->theme == 'white' ? 'text-color-dark-grey text-charcoal-900' : 'text-color-white'); ?> hover:underline"
                        ...
                        <div class="border-solid border-t mt-6 mb-6 border-charcoal-50 undefined <?php echo e($setting->theme == 'white' ? 'bg-black' : 'bg-white'); ?>"></div>
                    </div>
                            ...
                            <div class="<?php echo e($setting->theme == 'white' ? 'bg-white' : 'bg-black'); ?> flex gap-6 w-full shrink justify-between">
                                <div class="flex flex-col">
                                    <a class="<?php echo e($setting->theme == 'white' ? 'text-color-dark-grey text-charcoal-900' : 'text-color-white'); ?> mb-4 hover:underline"
                                        ...
                                        <h2 class="font-headline-2xs font-medium <?php echo e($setting->theme == 'white' ? 'text-color-dark-grey text-charcoal-900' : 'text-color-white'); ?>">
                                            <?php echo e($data->title); ?>

                                        </h2>
                                    </a>
                                    <p class="font-body <?php echo e($setting->theme == 'white' ? 'text-color-dark-grey text-charcoal-600' : 'text-color-white'); ?> mb-4 line-clamp-3">
            ...
            <div class="flex flex-col justify-center mdmax:ml-0 mdmax:mr-0 mb-8 container-mobile-md container-tablet-medium container-desktop-lg container-desktop-xl">
                <div class="flex gap-4 mdmax:flex-col justify-start items-start mdmax:w-full">
                   ...
                   <div class="flex flex-wrap gap-4 justify-start items-start mdmax:w-full">
                    ...
                    <div class="basis-full <?php echo e($setting->theme == 'white' ? 'text-color-dark-grey text-charcoal-900' : 'text-color-white'); ?> text-sm font-semibold uppercase h-min"><a
                            class="font-title <?php echo e($setting->theme == 'white' ? 'text-color-dark-grey text-charcoal-600' : 'text-color-white'); ?> uppercase flex"
                    ...
                    <div class="flex flex-col flex-1 gap-4 content-card-image--story-card h-auto"><a
                        ...
                        <a
                        class="hover:underline <?php echo e($setting->theme == 'white' ? 'text-color-dark-grey text-charcoal-900' : 'text-color-white'); ?>"
                        href="<?php echo e(route('article_detail', [$item?->first ?? 'post', $item?->id])); ?>">
                        <h2 class="<?php echo e($setting->theme == 'white' ? 'text-color-dark-grey text-charcoal-900' : 'text-color-white'); ?> font-headline-2xs font-medium">
                            <?php echo e($item->title); ?>

                        </h2>
                    </a>
                    <p><span class="mr-2 font-metadata font-medium <?php echo e($setting->theme == 'white' ? 'text-color-dark-grey text-charcoal-900' : 'text-color-white'); ?> uppercase">By 
                ...
                <div class="flex flex-wrap justify-center flex-col border-0 md:gap-6 mdmax:gap-4 container-mobile-md container-tablet-medium container-desktop-lg md:mt-8 mdmax:mt-6 mdmax:mx-0">
                    ...
                    <div class="flex flex-col <?php echo e($setting->theme == 'white' ? 'text-color-black' : 'text-color-white'); ?> border-solid border-0 border-b border-t border-charcoal-50 gap-6 md:pb-6 mdmax:pb-4 md:pt-6 mdmax:pt-4 w-full">
                      <div  class="font-metadata text-color-charcoal-600 uppercase flex flex-row justify-start border-solid border-0 gap-6">
                        ...
                        <span class="flex self-center ml-2 <?php echo e($setting->theme == 'white' ? 'text-color-dark-grey text-charcoal-900' : 'text-color-white'); ?>"><?php echo e($date); ?></span></div>
                    </div>
                      ...
                      <div class="<?php echo e($setting->theme == 'white' ? 'bg-white' : 'bg-black'); ?> flex gap-6 w-full shrink justify-between">
                        <div class="flex flex-col">
                          <a class="<?php echo e($setting->theme == 'white' ? 'text-color-dark-grey text-charcoal-900' : 'text-color-white'); ?> mb-4 hover:underline"
                            ...
                            <h2 class="font-headline-xs font-normal <?php echo e($setting->theme == 'white' ? 'text-color-dark-grey text-charcoal-900' : 'text-color-white'); ?>">
