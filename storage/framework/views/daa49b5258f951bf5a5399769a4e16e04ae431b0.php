  ...
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@simonwep/pickr/dist/themes/classic.min.css"> <!-- Classic theme -->
    ...
    <div class="container-fluid">
              ...
              <div class="col-2">
                ...
                <div class="modal fade" id="add" tabindex="-1"  aria-hidden="true" >
                  <div class="modal-dialog modal-xl">
                      <form enctype="multipart/form-data" action="<?php echo e(route('create_event')); ?>" method="post" class="modal-content border-0">
                        <?php echo csrf_field(); ?>  
        ...
        <table id="table" class="table text-nowrap mb-0 align-middle">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <tr>
                    ...
                    <td>
                        <h6 class="fw-semibold mb-0">
                            <?php echo e(\Carbon\Carbon::parse($data->event_date)->toFormattedDateString()); ?>

                            <?php echo e(\Carbon\Carbon::parse($data->event_date)->format('g:i A')); ?>
                    ...
                    <td>
                        <div class="dropdown dropstart">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                ...
                                <li>
                                    <a class="dropdown-item d-flex align-items-center gap-3" href="<?php echo e(route('delete_event', $data->id)); ?>"><i class="fs-4 ti ti-trash"></i>Delete</a>
                                </li>
                            </ul>
                            <div class="modal fade" id="edit<?php echo e($count); ?>" tabindex="-1"  aria-hidden="true" >
                                <div class="modal-dialog modal-xl">
                                    <form enctype="multipart/form-data" action="<?php echo e(route('update_event', $data->id)); ?>" method="post" class="modal-content border-0">
                                      <?php echo csrf_field(); ?>  
                                      <div class="modal-header text-bg-primary">
                                          ...
                                          <div class="notes-box">
                                            <div class="notes-content">
                                              <div>
                                                ...
                                                <div class="mb-3">
                                                    <label  class="form-label">Title *</label>
                                                    <input required name='title' value="<?php echo e($data->title); ?>" placeholder="" type="text" class="form-control">
                                                  </div>
                                                  <div class="mb-3">
                                                    <label  class="form-label">Link *</label>
                                                    <input required name='category' value="<?php echo e($data->category); ?>" placeholder="" type="text" class="form-control">
                                                  </div>
                                                   <div class="mb-3"  wire:ignore>
                                                    <label  class="form-label">Content *</label>
                                                    <textarea id="text<?php echo e($count); ?>"  required name="content" style="height:400px;"  placeholder="" type="text" class="form-control"><?php echo $data->content; ?></textarea>
                                                  </div>
